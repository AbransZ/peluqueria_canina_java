...
/*
 @author AbransZ
 */
public class Edit_Patitas1 extends javax.swing.JFrame {
    ...
    public Edit_Patitas1(int num_cliente) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, 520, 66));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.editar(mascota,nombreMascota,Raza,Color,Alergias,Cuidados,Observaciones,nombreDueño,Celular,Direccion);
    ...
    public void CargarDatos(int num_cliente) {
        ...
        this.mascota = control.mostrarMascota(num_cliente);
    
        txtNombre.setText(mascota.getNombreCli());
        txtRaza.setText(mascota.getRaza());
        txtCelular.setText(mascota.getDueñoCli().getCelular());
        txtColor.setText(mascota.getColor());
        txtDireccion.setText(mascota.getDueñoCli().getDireciion());
        txtobservaciones.setText(mascota.getObservaciones());
        txtNombreDueño.setText(mascota.getDueñoCli().getNombre());
        txtID.setText(String.valueOf(mascota.getId()));
        
        if(mascota.getAlergias().toUpperCase().equals("SI"))
        {
        cmbAlergia.setSelectedIndex(1);
        }
        else if(mascota.getAlergias().toUpperCase().equals("NO"))
        {
        ...
        if(mascota.getAtencionTipo().toUpperCase().equals("SI"))
        {
        cmbAtencion.setSelectedIndex(1);
        }
        else if(mascota.getAtencionTipo().toUpperCase().equals("NO"))
        {
